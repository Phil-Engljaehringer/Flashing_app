...
import FourWayHelper from './helpers/FourWay.js';

import MCU from './Hardware/MCU.js';
import Silabs from './Hardware/Silabs.js';
import Arm from './Hardware/Arm.js';

import {
  ACK,
  COMMANDS,
  MODES,
} from './FourWayConstants.js';
import { NotEnoughDataError } from './helpers/QueueProcessor.js';
...
class FourWay {
  ...
  increasePacketErrors(count) {
    if (this.packetErrorCallback) { this.packetErrorCallback(count); }
  }
